...
public class IslamicWallpaperRenderer extends RajawaliRenderer {
    ...
    private int wallpaperResource = R.drawable.ic_leilehaillaallah3;
    ...
    public void changeBackground(int resource) {
        ...
        wallpaperResource = resource;
        SimpleMaterial planeMat = new SimpleMaterial();
        Bitmap texture = BitmapFactory.decodeResource(mContext.getResources(), wallpaperResource);
        planeMat.addTexture(mTextureManager.addTexture(texture, TextureType.DIFFUSE));
        Plane plane = new Plane(11, 6.30f, 1, 1);
        plane.setRotZ(-90);
        plane.setMaterial(planeMat);
        addChild(plane);
