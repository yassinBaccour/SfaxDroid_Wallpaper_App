...
class WallpaperSchedulerFragment : Fragment() {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        buttonAddLwp = view.findViewById(R.id.button_add_lwp)
        buttonLWPList = view.findViewById(R.id.button_lwp_list)
        buttonActive = view.findViewById(R.id.button_active)
        buttonClose = view.findViewById(R.id.button_close)
        txtNotForget = view.findViewById(R.id.txt_not_forget)
        txtstatus = view.findViewById(R.id.txt_status)
        container = view.findViewById(R.id.container)
        radioOneHour = view.findViewById(R.id.radio_one_houre)
        radioSixHour = view.findViewById(R.id.radio_six_houre)
        radioTwelveHour = view.findViewById(R.id.radio_half_day)
        radioOneDay = view.findViewById(R.id.radio_one_day_houre)
